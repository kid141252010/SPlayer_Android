...
// 创建全局实例
let streamingStoreInstance: ReturnType<typeof createStreamingStore> | null = null;

/**
 * 获取流媒体 Store 实例
 */
export const useStreamingStore = () => {
  if (!streamingStoreInstance) {
    streamingStoreInstance = createStreamingStore();
  }
  return streamingStoreInstance;
};
